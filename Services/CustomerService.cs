...
namespace WebApi.Services
{
    ...
    public class CustomerService : ICustomerService
    {
        ...
        public CustomerService(IOptions<ConnectionStrings> connectionStrings, IOptions<ConfigEmailBase> configEmail, IOptions<StorageConfig> storageConfig, IWebHostEnvironment env)
        {
