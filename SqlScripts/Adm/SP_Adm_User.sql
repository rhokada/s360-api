-- =============================================================================
-- SP_Adm_sl_User — Seleciona usuários com filtros opcionais
-- =============================================================================
IF OBJECT_ID('SP_Adm_sl_User', 'P') IS NOT NULL DROP PROCEDURE SP_Adm_sl_User;
GO
CREATE PROCEDURE SP_Adm_sl_User
    @UserId     INT            = NULL,
...
END
GO
GRANT EXECUTE ON SP_Adm_sl_User TO S360sys;
GO

-- =============================================================================
-- SP_Adm_in_User — Insere um novo usuário
-- =============================================================================
IF OBJECT_ID('SP_Adm_in_User', 'P') IS NOT NULL DROP PROCEDURE SP_Adm_in_User;
GO
CREATE PROCEDURE SP_Adm_in_User
    @AppId      VARCHAR(100)   = NULL,
    @Name       VARCHAR(500)   ,
    @Email      VARCHAR(100)   ,
...
END
GO
GRANT EXECUTE ON SP_Adm_in_User TO S360sys;
GO

-- =============================================================================
-- SP_Adm_up_User — Atualiza um usuário existente
-- =============================================================================
IF OBJECT_ID('SP_Adm_up_User', 'P') IS NOT NULL DROP PROCEDURE SP_Adm_up_User;
GO
CREATE PROCEDURE SP_Adm_up_User
    @UserId     INT            ,
    @AppId      VARCHAR(100)   = NULL,
    @Name       VARCHAR(500)   = NULL,
    @Email      VARCHAR(100)   = NULL,
...
END
GO
GRANT EXECUTE ON SP_Adm_up_User TO S360sys;
GO

-- =============================================================================
-- SP_Adm_dl_User — Remove um usuário (soft delete via Active = 0)
-- =============================================================================
IF OBJECT_ID('SP_Adm_dl_User', 'P') IS NOT NULL DROP PROCEDURE SP_Adm_dl_User;
GO
CREATE PROCEDURE SP_Adm_dl_User
    @UserId        INT ,
    @token_usuario NVARCHAR(MAX) = NULL
AS
BEGIN
...
END
GO
GRANT EXECUTE ON SP_Adm_dl_User TO S360sys;
GO
